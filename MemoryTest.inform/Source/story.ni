...
Understand "Remember [something]", "think about [something]" as remembering. 

Carry out remembering something (called the memory):
  if the memory is part of the player, say "[the memory]";
  otherwise say "You don't remember that.".
...
after examining the picture: 
	if getting married is not part of the player: 
		say "Ah, now I remember!";
		now getting married is part of the player; 
	now getting married is strong. 
